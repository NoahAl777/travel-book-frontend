  ...
  return (
    <div className="App">
      ...
      <Routes>
        ...
        <Route path="/destinations/:destination_id/notes/:note_id/edit" element={<EditNotesForm selectedNote={selectedNote} destinations={destinations} setDestinations={setDestinations} notes={notes} setNotes={setNotes} />} />
      </Routes>
    </div>
  );
}
